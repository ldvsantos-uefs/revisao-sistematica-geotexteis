...
Figure 6b indicates a negative association between exposure time and UTS in *Typha domingensis* across NaOH concentrations (β ranging from −0.021 to −0.057 N/mm$^2$·day$^{-1}$; p ≤ 0.010; R$^2$ = 0.844–0.922; 84.4–92.2% variance explained), consistent with temporal degradation. In *Syagrus coronata*, the association is supported at 6% and 9% NaOH (β = −0.099; t = −3.955; p = 0.029; R$^2$ = 0.839; 83.9% variance explained; and β = −0.108; t = −5.067; p = 0.015; R$^2$ = 0.895; 89.5% variance explained), whereas 0% and 3% do not show robust evidence over the available time points (p ≥ 0.144).
